...
import org.firstinspires.ftc.teamcode.util.messages.TwoDeadWheelInputsMessage;

@Config
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 484.059511080987; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1136.3059295609023; // x position of the perpendicular encoder (in tick units)
    }
